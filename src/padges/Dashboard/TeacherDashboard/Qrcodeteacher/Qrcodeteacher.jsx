...
export default function Qrcodeteacher() {
  ...
  const handleNewSection = () => {
    const newSectionData = `section_${new Date().getTime()}`;
    setQrData(newSectionData);
    setQrVisible(true);
  };
  return (
    <div className=''>
...
>
  ...
  <span className="flex-1 text-start text-[#A1A1A1]  whitespace-nowrap">section number</span>
...
>
  <li onClick={handleNewSection}  className="flex items-center md:w-[51%] max-md:w-[95%] p-2 cursor-pointer border-[1px] border-[#A1A1A1] text-gray-900 transition duration-75 rounded-lg  hover:bg-gray-100 " >
  <span className="inline-flex items-center justify-center px-2 text-sm font-medium ">
        <img src={plues} alt="" />
      </span>
      <span className="flex-1 ms-3 text-[#161B39] text-start whitespace-nowrap">add new section </span>
  </li>
  ...
  <span className="inline-flex items-center justify-center px-2 text-sm font-medium ">
       ...
       <span className="flex-1 ms-3  text-[#161B39] text-start whitespace-nowrap">  section 1 </span>
  </li>
</ul>
</li>
            </ul>
      ...
      {qrVisible && (
        ...
        <div className='text-center  mt-[8%] '>
                     <h3 className='text-xl mb-5   '>section QR code</h3>
