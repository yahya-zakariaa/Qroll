  ...
  return (
    ...
    <div className='lg:flex items-center  lg:justify-between '>
        <div className='flex  gap-2 m-3 lg:m-3 justify-self-center'>
                 ...
                 <div className='flex '>
                    <button className='border border-[#161B39] text-[#161B39] m-2 w-48 max-md:text-[13px]  rounded-[8px] h-11'>import from excel sheet</button>
                    ...
                    <i className="fa-solid fa-plus" />
                       <p className='p-2'  onClick={() => navigate("/teacher-dashboard/coursestecher/addnewstudentteacher")}>Add new student </p>
                    </button>
        ...
        <table className="md:w-[60%] lg:w-[95%] ">
          <thead className="">
            <tr>
              ...
              <th className="px-4 py-2 text-left text-sm font-medium text-[#A1A1AA]">Student ID</th>
            </tr>
          </thead>
          <tbody>
