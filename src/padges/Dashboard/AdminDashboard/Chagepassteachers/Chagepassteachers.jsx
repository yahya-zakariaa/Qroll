...
export default function Chagepassteachers() {
  ...
  return (
    <div>
      <div className="flex gap-6 md:m-10 max-md:m-3 items-center">
        ...
        <i className="fa-solid fa-chevron-right" style={{ color: "#71717a" }} />
        <h1 className="text-[#71717A] ">teacher information </h1>
        <i className="fa-solid fa-chevron-right" style={{ color: "#71717a" }} />
      ...
      <div className="mx-[5%]">
        ...
        <div className="mb-5 w-[55%] m-auto mt-14 ">
          <button className="bg-[#161B39] text-white  w-[191px] h-[49px] rounded-[12px]">
            save password
          </button>
        </div>
      </div>
