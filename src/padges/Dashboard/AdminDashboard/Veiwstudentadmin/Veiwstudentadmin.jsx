...
export default function Veiwstudentadmin() {
  ...
  const { getStudent, deleteStudent } = useAdminStore();
    ...
    <div>
      <div className="lg:flex items-center lg:justify-between ">
        <div className="flex gap-2 m-3 lg:m-3 justify-self-center">
          <h1 className="text-[#71717A] ">Students </h1>
          <i
        ...
        <div className="flex ">
          <button
            ...
            className="bg-[#EF1A1D] text-[white] m-2 w-32 max-md:text-[13px] rounded-[8px] h-11"
          >
            delete Student
          </button>
          <button
