...
export default function CourseStudent() {
  ...
  const pageSize = 9;
  const { getStudentsInCourse } = useAdminStore();
  ...
  return (
    <div>
      <div className="Students-center lg:flex lg:justify-between ">
        <div className="flex gap-2 m-3 lg:m-3 justify-self-center">
          <button
            onClick={() => navigate(-1)}
            className="flex gap-2 Students-center  text-[#161B39]"
          >
        ...
        <div className="flex ">
          ...
          <button className=" max-md:text-[13px] flex Students-center self-center justify-center bg-[#161B39] text-[white] m-2 w-48  rounded-[8px] h-11">
              ...
              <tbody>
                {currentStudents.map((student) => (
                  <tr
                    ...
                    onClick={() =>
                      navigate(
                        `/admin-dashboard/veiwstudentadmin/${student.student_id}`
                      )
                    }
                  >
