...
export default function Allteachersadmin() {
  ...
  const { getTeachers, deleteTeacher } = useAdminStore();
  const pageSize = 9;
  ...
  const handleDeleteTeacher = async (id) => {
    ...
    try {
      const res = await toast.promise(deleteTeacher(id), {
    ...
    <>
      <div className="lg:flex items-center  lg:justify-between ">
        <div className="flex  m-3 lg:m-3 gap-4 md:justify-start justify-around items-center">
          ...
          <h1 className="text-[#71717A] ">Teacher </h1>
          <i
                    ...
                    <td className="px-4 py-2 text-sm text-gray-600">
                      <div className="flex gap-2">
                        <button
                          onClick={() =>
                            navigate(
                              `/admin-dashboard/veiwteacheradmin/${item.teacher_id}`
                            )
                          }
                        ...
                        <button
                          onClick={() => handleDeleteTeacher(item?.teacher_id)}
