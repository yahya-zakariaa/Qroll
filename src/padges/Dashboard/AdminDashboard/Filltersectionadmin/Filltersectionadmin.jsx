    ...
    <div>
         <div className='items-center lg:flex lg:justify-between'>
                <div className='flex gap-2 m-3 max-sm:m-5'>
                         ...
                         <h1 className='text-[#71717A] max-md:text-[11px]'> view all </h1>
                         <i className="fa-solid fa-chevron-right md:mt-1" style={{ color: "#71717a" }} />
                         <h1 className='text-[#71717A] max-md:text-[11px] '>  HTML   </h1>
          <i className="fa-solid fa-chevron-right md:mt-1" style={{ color: "#71717a" }} />
                         <h1 className='text-[#71717A] max-md:text-[11px] '>  filter by   </h1>
