     ...
     <div>
      ...
      <h1>BACK</h1> 
                 ...
                 <div>
                   ...
                   <button onClick={() => navigate("/doctor-dashboard/coursessdoctoer/sectionfilterdocter")} className="w-[20%] h-14 border-[1px] border-[#161B39] text-[#161B39] rounded-[7px]">section 1</button>
                                 </div>
                 </div>
                 ...
                 <div>
                   ...
                   <div className='flex flex-wrap gap-4 mt-8 '>
                   <button onClick={() => navigate("/doctor-dashboard/coursessdoctoer/lecturesfilterdoctoer")} className="w-[20%] h-14 border-[1px] border-[#161B39] text-[#161B39] rounded-[7px]">lectures 1</button>
                                 </div>
                 </div>
