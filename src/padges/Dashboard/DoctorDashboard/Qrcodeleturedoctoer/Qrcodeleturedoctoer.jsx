...
export default function Qrcodeleturedoctoer() {
     const [isOpen, setIsOpen] = useState(false);
      ...
      const handleNewSection = () => {
        const newSectionData = `lecture_${new Date().getTime()}`;
  ...
  return (
   ...
   >
     ...
     <span className="flex-1 text-start text-[#A1A1A1]  whitespace-nowrap"> choose lecture number</span>
   ...
   >
     ...
     <span className="inline-flex items-center justify-center px-2 text-sm font-medium ">
         ...
         <span className="flex-1 ms-3 text-[#161B39] text-start whitespace-nowrap">add new lecture  </span>
     ...
     <span className="inline-flex items-center justify-center px-2 text-sm font-medium ">
          ...
          <span className="flex-1 ms-3  text-[#161B39] text-start whitespace-nowrap">   lecture 1 </span>
