  ...
  return (
    <div>
      <div className="flex gap-6 md:m-10 max-md:m-3 items-center">
        <button
          onClick={() =>
            navigate("/student-dashboard/coursesstudent/scanqrcodestudent")
          }
      ...
      <div className="relativew-full ">
        <div className=" lg:w-[18%] absolute top-[25%] md:left-[46%] max-md:w-[70%] max-md:left-[22%] ">
          <p className="text-2xl max-lg:mr-32 text-center max-md:mr-5">
            Qr code for lecture 2 Have been scanned successfully{" "}
          </p>
          <img className="h-[211.67px] w-[211.67px]" src={susses} alt="" />
          <button
            onClick={() => navigate("/student-dashboard/coursesstudent")}
            className="bg-[#161B39] w-56 h-10 my-5 rounded-[9px] text-white flex justify-center items-center gap-2"
          >
