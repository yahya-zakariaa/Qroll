   ...
   <aside id="sidebar-multi-level-sidebar"
     ...
     <div className="h-full px-3 py-4  bg-[#161B39]">
        <ul className="space-y-2 font-medium">
           <li onClick={closeSidebar} className="flex items-center p-2  rounded-lg text-white hover:bg-gray-700 group">
           <img className='m-2' src={logos} alt="" />
              
              <div className='h-[1px] bg-[#575757]  mt-8 mb-5'></div>
           </li>
           <li onClick={closeSidebar} className="flex items-center p-2 mb-5  rounded-lg text-white hover:bg-gray-700 group" >
           ...
           <li onClick={closeSidebar}>
              <Link to="/doctor-dashboard" className="flex items-center p-2  rounded-lg text-white hover:bg-gray-700 group">
              <span className='ml-0' >
                 <img src={home} alt="" />              
                 </span>
           ...
           <li onClick={closeSidebar}>
              <Link to="/doctor-dashboard/profiledoctoer" className="flex items-center p-2  rounded-lg text-white hover:bg-gray-700 group">
           ...
           >
             <li>
               <Link
                 to="/doctor-dashboard/coursessdoctoer"
