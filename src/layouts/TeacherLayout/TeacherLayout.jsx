...
const closeSidebar = () => setIsOpen(false);
  ...
  return (
    ...
    <button  onClick={toggleSidebar}
        ...
        type="button"
        className="inline-flex items-center p-2 mt-2 text-sm text-gray-500 rounded-lg ms-3 sm:hidden  focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 hover:bg-gray-700 dark:focus:ring-gray-600">
...
<aside id="sidebar-multi-level-sidebar"
  ...
  <div className="h-full px-3 py-4   bg-[#161B39]">
     <ul className="space-y-2 font-medium">
        <li onClick={closeSidebar} className="flex items-center p-2 text-white  hover:bg-gray-700 group" >
        <img className='m-2' src={logos} alt="" />

           <div className='h-[1px] bg-[#575757]  mt-8 mb-5'></div>
        </li>
        <li onClick={closeSidebar} className="flex items-center p-2 mb-5  rounded-lg ext-white text-white hover:bg-gray-700 group">
        ...
        <li onClick={closeSidebar}>
           <Link to="/teacher-dashboard" className="flex items-center p-2  rounded-lg text-white  hover:bg-gray-700 group">
           <span className='ml-0' >
              <img src={home} alt="" />              
              </span>
        ...
        <li onClick={closeSidebar}>
           <Link to="/teacher-dashboard/profileteacher" className="flex items-center p-2  rounded-lg text-white  hover:bg-gray-700 group">
        ...
        >
          ...
          <li onClick={closeSidebar} className='fixed bottom-5 w-52'>
            <Link  to="/home" className="flex items-center p-2  rounded-lg text-white hover:bg-gray-700 group">
